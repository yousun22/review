...
const pingInterval = 15 * 60 * 1000; // 15분
const secondPingDelay = 1 * 60 * 1000; // 1분
const timeoutThreshold = 5 * 60 * 1000; // 20분
...
var server = net.createServer(function(socket) {
    ...
    clients[clientKey] = clients[clientKey] || { socket, phonenum: null, timer: null };
